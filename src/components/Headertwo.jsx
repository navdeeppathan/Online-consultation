                  ...
                  <>
                    <div className="d-flex align-items-center gap-3 position-relative">
                      ...
                      {/* <div className="dropdown">
                        <button
                          className="btn btn-link text-decoration-none login-btn"
                          onClick={() => setLoginDropdown((prev) => !prev)}
                        >
                          Login
                          <MdArrowDropDown size={20} className="ms-1" />
                        </button>
      ...
      >
        ...
        <Modal.Body className="p-0 register-modal">
          <div className="row ">
            ...
            >
              <h3 className="modal-title mb-3">Join as Practitioner</h3>
        ...
        <Modal.Body>
          ...
          >
            <div className="text-center my-4">
              <h4 className="mb-3 font-weight-bold">Welcome to Yodoc</h4>
