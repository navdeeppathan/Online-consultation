    ...
    >
      ...
      <div className="yp-container" role="main">
        ...
        <section className="intro-section">
          ...
          <p>
            ...
            “our”) collects, uses, stores, and shares your personal information
            when you use our platform, which includes:
          </p>
          <ul>
          ...
          <p>
            ...
            review, and book appointments with healthcare professionals (“the
            Yodoc Platform”).
          </p>
          <p>
            We do not provide medical services ourselves. All consultations and
            healthcare services are delivered by independent, registered medical
            professionals.
          </p>
          <p>
            This notice applies to both patients and healthcare professionals
        ...
        <section className="imp-section">
          ...
          <p>
            We review this policy regularly. Updates will appear on this page
            and, where appropriate, be notified to you directly.
          </p>
      ...
      `}</style>
        ...
        <section className="data-section">
          ...
          <ul>
            ...
            <li>
              Health Data (limited): Information necessary to arrange or confirm
              your appointment.
            </li>
            ...
            <li>Marketing Preferences: Communication and opt-in choices.</li>
          </ul>

          <h3>3.2 Healthcare Professionals</h3>
          <p>We collect limited professional data to display your profile:</p>
          <ul>
            <li>
              Identity and Registration Data: Name, title, GMC or relevant
      ...
      `}</style>
        ...
        <section className="collect-section">
          ...
          <ul>
            ...
            <li>
              From healthcare professionals: to confirm appointments or respond
              to feedback.
            </li>
          </ul>
      ...
      `}</style>
        ...
        <section className="use-section">
          ...
          <ul>
            <li>Manage appointment bookings and confirmations (Contract);</li>
            <li>
              Share booking details with the chosen healthcare provider{" "}
              (Explicit Consent);
            </li>
            <li>Publish and verify patient reviews (Legitimate Interests);</li>
            <li>
              Send reminders, updates, and service communications (Contract);
            </li>
            <li>
          ...
          <p className="note">
            ...
            professional or clinic. Once shared, that provider becomes the data
            controller for your consultation data. Please review their privacy
      ...
      `}</style>
        ...
        <section className="payment-section">
          ...
          <p>
            Yodoc uses trusted third-party payment processors to manage all card
            payments securely.
          </p>

          <p>We do not collect, store, or process your full card details.</p>

          <p>
            When you make a payment, your card information is transmitted
            directly to our payment partner, such as Stripe, PayPal, or another
            PCI DSS–compliant provider, in an encrypted and secure manner.
          </p>

          <p>
            We only receive a transaction reference or token for record-keeping
            and reconciliation purposes.
          </p>

          <p>
            We may retain limited payment information (e.g. transaction date,
            amount, booking ID) to:
          </p>
          ...
          <p>
            Our payment partners process card data in full compliance with the
      ...
      `}</style>
        ...
        <section className="share-section">
          ...
          <ul>
            ...
            <li>
              With service providers who operate parts of our platform (hosting,
              payments, analytics);
            </li>
          ...
          <p>
            We retain personal data only as long as necessary for its purpose or
