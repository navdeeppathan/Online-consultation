    ...
    <>
      ...
      `}</style>
          ...
          <p>
            ...
            using the Yodoc website, mobile application, and related services
          ...
          <ul>
            <li>
              “Yodoc”, “we”, “us”, or “our” refers to Yodoc, a company
              incorporated in England and Wales, with its registered office at{" "}
          ...
          <p>
            ...
            professional conduct and compliance with applicable laws and medical
            standards.
          </p>
          ...
          <ul>
            ...
            <li>
              Yodoc is not liable for the clinical outcome of any consultation
              or advice provided by a Healthcare Provider.
            </li>
            <li>
          ...
          <p>
            ...
            reserve the right to withdraw or amend any part of the Platform
            without notice.
          </p>
          ...
          <p>
            3.4. Yodoc reserves the right to suspend or terminate your access if
          ...
          <p>
            4.3. For virtual consultations, the Platform may provide a secure
            video link or interface. You are responsible for ensuring a stable
            internet connection and appropriate privacy during the session.
          </p>

          <p>
            4.4. For in-person consultations, details of the clinic or practice
          ...
          <p>
            5.1. Yodoc facilitates payments on behalf of Healthcare Providers
          ...
          <p>
            5.5. Yodoc is not responsible for disputes over fees, cancellations,
            or refunds between Users and Healthcare Providers.
          </p>
          ...
          <p>
            6.2. Any medical advice, diagnosis, or treatment is delivered solely
            by the Healthcare Provider you consult with.
          </p>
          <p>
          ...
          <ul>
            ...
            <li>
              The information provided on their Yodoc profile is accurate and up
              to date; and
            </li>
            <li>
          ...
          <p>
            7.2. Yodoc does not independently verify the clinical qualifications
            of every Healthcare Provider but may conduct background checks where
            appropriate.
          </p>
          ...
          <p>
            ...
            and display such content for operational and promotional purposes.
          </p>
          ...
          <p>
            11.1. Yodoc collects and processes personal data in accordance with
            its Privacy Policy,available at here.
          </p>
          ...
          <div>
            <p>
              12.1 Yodoc may terminate your account if you breach these Terms.
            </p>
