    ...
    const fetchLogs = async () => {
      ...
      try {
        const response = await axios.get(
          `${Config.BASE_URL}/api/activity-logs`
        );
                  ...
                  <table className="table table-striped custom-table approvedtable">
                    ...
                    <tbody>
                      {currentPatients.map((patient, index) => (
                        <tr key={patient.id}>
                          <td className="smallfont">{index + 1}</td>
                          <td className="smallfont">{patient.activity_type}</td>
                          ...
                          <td className="smallfont">{patient.description}</td>
...
export default AdminAllActivityLogs;
