...
import icon3 from "../../assets/admin/d3.png";
...
import icon8 from "../../assets/admin/pl.png";
...
import hovericon2 from "../../assets/admin/dh2.png";
import hovericon3 from "../../assets/admin/dh3.png";
...
const AdminSidebar = () => {
  const menuItems = [
...

    {
      ...
      icon: paymentIcon,
      hoverIcon: paymentIcon,
    },
    {
      label: "Yodoc Charges",
      to: "/admin-yodocharges",
      icon: icon6,
  ...
  return (
    <>
      ...
      {/* Sidebar Container */}
      <div className={`sidebar-wrapper ${isOpen ? "open" : ""} d-md-block`}>
