...
const AllOnlineDoctor = () => {
  ...
  const fetchDrData = async () => {
    try {
      ...
      setFilteredDoctors(response.data.doctors); // Initial list
    } catch (error) {
      console.error(
      ...
      >
        ...
        <div className="">
              ...
              <div className="search-box">
                <div className="search-input-group">
                  ...
                  <input
                    ...
                    placeholder="Search by Dr. Name ,Speciality"
                    value={query}
          ...
          {/* <div className="col-md-6">
              <img src={rightimage} alt="image" className="imgright" />
            </div> */}
          {/* </div> */}
        </div>
...
export default AllOnlineDoctor;
