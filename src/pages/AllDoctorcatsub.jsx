  ...
  const fetchDrData = async () => {
    try {
      ...
      const videotypedoctor = AllData.filter((doctor) => {
        ...
        const filterExp = selectedFilters?.experience?.toString().trim() || "";
                  ...
                  >
                    <div className="doctor-card p-2 shadow-sm">
                      ...
                      <div className="startdatatext">
                        ...
                        >
                          {/* <div className="col-3">
                            <strong className="text-primary fontsize">
                              {doctor.overall_feedback_percentage}%
                            </strong>
                            <p className="small text-muted mb-0 fontsize">
                              Satisfied
                            </p>
                          </div> */}
                          <div className="col-3">
                          ...
                          {/* <div className="col-3">
                            <strong className="text-dark fontsize">
...
export default AllDoctorcatsub;
